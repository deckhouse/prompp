...
func New(logger log.Logger, o *Options, receiver handler.Receiver) *Handler { // OP_CHANGES.md: rebuild on cpp
	if logger == nil {
	...
	router.Get("/federate", readyf(httputil.CompressionHandler{
		Handler: http.HandlerFunc(h.opFederation), // OP_CHANGES.md: rebuild on cpp
	}.ServeHTTP))
