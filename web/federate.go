...
func (h *Handler) federation(w http.ResponseWriter, req *http.Request) {
	...
	q, err := h.storage.Querier(mint, maxt) // OP_CHANGES.md: rebuild on cpp
	if err != nil {
	...
	ctx = cppbridge.SetCaller(ctx, cppbridge.LSSQuerySourceFederate) // OP_CHANGES.md: rebuild on cpp
