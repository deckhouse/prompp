...
def _third_party_deps_impl(_ctx):
    ...
    http_file(
        ...
        sha256 = "cd327808931bcd2db3a50900526d9f8fae349acc094af02e7b03d180360ea107",
        url = "https://github.com/fastfloat/fast_float/releases/download/v8.2.10/fast_float.h",
    )
