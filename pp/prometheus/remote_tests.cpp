...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(ReadQueryFromProtobufCase{
        ...
        .expected = true,
        .query = {.label_matchers = {{.name = "name", .value = "value", .type = MatcherType::kExactMatch}}, .start_timestamp_ms = 1, .end_timestamp_ms = 2}}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(ReadQueryFromProtobufCase{
        ...
        .expected = false,
        .query = {
            .label_matchers = {{.name = "name", .value = "", .type = MatcherType::kExactMatch}},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(ReadQueryFromProtobufCase{
        ...
        .expected = true,
        .query = {.label_matchers = {{.name = "name", .value = "value", .type = MatcherType::kExactMatch},
                                     {.name = "name2", .value = "value2", .type = MatcherType::kRegexpNotMatch}},
                  .start_timestamp_ms = 1,
                  .end_timestamp_ms = 2}}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(ReadLabelValuesQueryFromProtobufCase{
        ...
        .expected = false,
        .query = {
            .query = {.label_matchers = {{.name = "cron", .value = "job", .type = MatcherType::kExactMatch}}, .start_timestamp_ms = 1, .end_timestamp_ms = 2},
            .label_name = {}}}));
INSTANTIATE_TEST_SUITE_P(
    ValidQuery,
    ReadLabelValuesQueryFromProtobufFixture,
...
INSTANTIATE_TEST_SUITE_P(Test,
                         ...
                         testing::Values(WriteLabelValuesQueryToProtobufCase{
                             .query = {.query = {.label_matchers = {{.name = "cron", .value = "job", .type = MatcherType::kExactMatch}},
                                                 .start_timestamp_ms = 1,
                                                 .end_timestamp_ms = 2},
                                       .label_name = "name"},
