...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(ScraperCase{.buffer = "a\n", .result = Error::kUnexpectedToken, .metrics = {}},
                    ...
                    ScraperCase{.buffer = "a{\xff=\"foo\"} 1\n", .result = Error::kInvalidUtf8, .legacy_result = Error::kUnexpectedToken, .metrics = {}},
                    ScraperCase{.buffer = "a{b=\"\xff\"} 1\n", .result = Error::kInvalidUtf8, .metrics = {}},
                    ScraperCase{.buffer = "a{b=\"\xc3", .result = Error::kInvalidUtf8, .legacy_result = Error::kUnexpectedToken, .metrics = {}},
                    ScraperCase{.buffer = "# comment \xff\n", .result = Error::kInvalidUtf8, .legacy_result = Error::kNoError, .metrics = {}},
                    ScraperCase{.buffer = "# comment \xff", .result = Error::kInvalidUtf8, .legacy_result = Error::kNoError, .metrics = {}},
