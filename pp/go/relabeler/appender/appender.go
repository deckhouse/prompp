...
func (qa *QueryableAppender) Append2(
	ctx context.Context,
	incomingData *relabeler.IncomingData,
	state *cppbridge.State,
	relabelerID string,
	...
	return qa.AppendWithStaleNans2(ctx, incomingData, state, relabelerID, commitToWal)
}

func (qa *QueryableAppender) AppendWithStaleNans2(
	ctx context.Context,
	incomingData *relabeler.IncomingData,
	state *cppbridge.State,
	relabelerID string,
	...
	data, stats, err := qa.head.Append2(ctx, incomingData, state, relabelerID, commitToWal)
	if err != nil {
		return cppbridge.RelabelerStats{}, err
	}
