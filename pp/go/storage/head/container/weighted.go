...
type Weighted[T any, H Head[T]] struct {
	wlocker *locker.Weighted
	head    *T
}

// NewWeighted init new [Weighted].
func NewWeighted[T any, H Head[T]](head H) *Weighted[T, H] {
	return &Weighted[T, H]{
...
func (c *Weighted[T, H]) Replace(ctx context.Context, newHead H) error {
...
func (c *Weighted[T, H]) With(ctx context.Context, fn func(h H) error) error {
