...
func TestMMapFile_Bytes(t *testing.T) {
	...
	func(t *testing.T) {
		mfile, err := NewMMapFile(tempFileName, os.O_CREATE|os.O_RDWR, 0o600, int64(targetSize))
		require.NoError(t, err)
		defer func() {
			_ = mfile.Close()
		}()
...
func TestMMap(t *testing.T) {
	...
	func(t *testing.T) {
		var file *os.File
		file, err = os.OpenFile(tempFileName, os.O_CREATE|os.O_RDWR, 0o755)
		require.NoError(t, err)
		defer func() {
	...
	func(t *testing.T) {
		testFile, err := os.OpenFile(tempFileName, os.O_CREATE|os.O_RDWR, 0o755)
		require.NoError(t, err)
		defer func() {
	...
	func(t *testing.T) {
		testFile, err := os.OpenFile(tempFileName, os.O_CREATE|os.O_RDWR|os.O_TRUNC, 0o755)
		require.NoError(t, err)
		defer func() {
			require.NoError(t, testFile.Close())
		}()
