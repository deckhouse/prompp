...
extern "C" void prompp_series_data_encoder_ctor(void* args, void* res) {
  ...
  new (res) Result{.encoder_wrapper = std::make_unique<entrypoint_types::SeriesDataEncoderWrapper>(*static_cast<Arguments*>(args)->data_storage)};
}
...
extern "C" void prompp_series_data_encoder_merge_out_of_order_chunks(void* args) {
  ...
  entrypoint_types::OutdatedChunkMerger{encoder}.merge();
}
