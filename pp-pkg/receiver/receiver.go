...
func (rr *Receiver) FindFromBuilder(
	...
	return rr.appender.FindFromBuilder(
		ctx,
		builderSortedAdd,
		builderSortedDel,
		builderSnapshot,
...
func (rr *Receiver) FindByHash(
	...
	return rr.appender.FindByHash(ctx, hash, builderSortedAdd, builderSortedDel, builderSnapshot, builderLSID)
}
