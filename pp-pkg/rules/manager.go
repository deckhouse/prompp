...
type Manager struct {
	...
	transparentStatelessRelabeler *cppbridge.StatelessRelabeler
...
func NewManager(o *ManagerOptions) (*Manager, error) {
	...
	transparentStatelessRelabeler, err := cppbridge.NewStatelessRelabeler([]*cppbridge.RelabelConfig{})
	if err != nil {
	...
	m := &Manager{
		...
		transparentStatelessRelabeler: transparentStatelessRelabeler,
		logger:                        o.Logger,
	}
