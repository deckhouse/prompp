...
import (
	...
	op_config "github.com/prometheus/prometheus/op-pkg/config" // OP_CHANGES.md: rebuild on cpp
...
type Config struct {
	...
	ReceiverConfig     op_config.RemoteWriteReceiverConfig `yaml:",inline,omitempty"`      // OP_CHANGES.md: rebuild on cpp
	RemoteWriteConfigs []*OpRemoteWriteConfig              `yaml:"remote_write,omitempty"` // OP_CHANGES.md: rebuild on cpp
...
// OP_CHANGES.md: rebuild on cpp start move to op_remote_write_config
// // UnmarshalYAML implements the yaml.Unmarshaler interface.
