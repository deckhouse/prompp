...
func TestXxx(t *testing.T) {
	...
	t.Log(lsA.Len())
	t.Log(lsB.DropMetricName().Len())

	t.Log(labels.Equal(lsA, lsB.DropMetricName()))
}
...
func TestXxx2(t *testing.T) {
	...
	t.Log(lsA.DropMetricName().Len())
	t.Log(lsB.DropMetricName().Len())

	t.Log(labels.Equal(lsA.DropMetricName(), lsB.DropMetricName()))
}
