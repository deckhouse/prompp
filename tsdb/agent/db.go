...
type DB struct {
	...
	logger log.Logger
	opts   *Options
	rs     RemoteWrite // OP_CHANGES.md: rebuild on cpp
...
func Open(l log.Logger, reg prometheus.Registerer, rs RemoteWrite, dir string, opts *Options) (*DB, error) { // OP_CHANGES.md: rebuild on cpp
