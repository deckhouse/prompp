<p align="center">
    <img alt="Prom++" src="https://github.com/deckhouse/prompp/blob/pp/documentation/images/prompp_light_logo.svg#gh-light-mode-only" alt="Prom++" width="391" height="133"/>
    <img alt="Prom++" src="https://github.com/deckhouse/prompp/blob/pp/documentation/images/prompp_dark_logo.svg#gh-dark-mode-only" alt="Prom++" width="391" height="133"/>
</p>
