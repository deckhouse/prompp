<p align="center">
    <img alt="Prom++" src="https://github.com/deckhouse/prompp/blob/legal/documentation/images/prompp_dark_logo.svg#gh-light-mode-only" alt="Prom++" width="196" height="66"/>
    <img alt="Prom++" src="/documentation/images/prompp_white_logo.svg#gh-dark-mode-only" alt="Prom++" width="196" height="66"/>
</p>
