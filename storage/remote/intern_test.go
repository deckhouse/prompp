...
func TestIntern(t *testing.T) {
	...
	require.True(t, ok)
	require.Equal(t, int64(1), interned.refs.Load(), "expected refs to be 1 but it was %d", interned.refs.Load())
}
...
func TestIntern_MultiRef(t *testing.T) {
	...
	require.True(t, ok)
	require.Equal(t, int64(2), interned.refs.Load(), "expected refs to be 2 but it was %d", interned.refs.Load())
}
